...
## Project Structure
    ...
    ├── epp_recycling_bin_33252  # Django project configurations
...
1. Clone this repo and `cd epp_recycling_bin_33252`
...
2. Clone this repo and `cd epp_recycling_bin_33252`
